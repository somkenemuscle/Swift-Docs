    ...
    <SlideIn direction='bottom'>
      <div id='pricing' className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <h1 className='text-left lg:text-center font-extrabold text-4xl md:text-6xl'>No need to worry about bills, <br /><span className='text-gray-400'>document for free</span> </h1>
